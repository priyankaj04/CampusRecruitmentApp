...
import { ApplicationById, UpdateApplicationDetailsById } from '../api';
...
const EditApplication = ({ route, navigation }) => {
    ...
    const handleClick = () => {
        ...
        jobDetails.created_at = new Date().toISOString();
        UpdateApplicationDetailsById(jobDetails, id).then((res) => {
            if (res.status) {
                navigation.goBack();
            }
        })
