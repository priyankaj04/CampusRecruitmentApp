...
const Subjects = ({ navigation }) => {
    ...
    const getData = async () => {
        console.log(await AsyncStorage.getItem('department'))
        setDept(await AsyncStorage.getItem('department'))
    }
    ...
    useEffect(() => {
        if (!dept) {
            ...
            if ((dept == 'Department of Computer Science' && degree == 'BCA') || (dept == 'Department of Computer Science' && degree == 'BVoc')) {
                setEdit(true);
            } else if (dept == 'Department of Science' && degree == 'BSc') {
                setEdit(true);
            } else if (dept == 'Department of Arts' && degree == 'BA') {
                setEdit(true);
            } else if (dept == 'Department of Commerce' && degree == 'Bcom') {
                setEdit(true);
            } else {
                setEdit(false);
            }
    ...
    const removeData = async () => {
        await AsyncStorage.multiRemove(['hod_id', 'user_type', 'department']);
    }
