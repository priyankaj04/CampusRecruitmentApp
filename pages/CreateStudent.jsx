...
const CreateStudent = () => {
    ...
    const Degrees = ['Bachelore of Science', 'Bachelore of Computer Science', 'Bachelore of Commerce', 'Bachelore of Arts'];
    ...
    const handleClick = () => {
        const reqbody = {
            ...
            created_by: id,
            subject_marks: [
                { I: semesterSubjects[0] },
                { II: semesterSubjects[1] },
                { III: semesterSubjects[2] },
                { IV: semesterSubjects[3] },
                { V: semesterSubjects[4] },
                { VI: semesterSubjects[5] }
            ]
        };
    ...
    const handleMarksChange = (semesterIndex, subjectIndex, marks) => {
        const updatedSemesterSubjects = [...semesterSubjects];
        updatedSemesterSubjects[semesterIndex][subjectIndex].marks = marks;
        setSemesterSubjects(updatedSemesterSubjects);
    };

    return (
        <View>
            <View style={{ position: 'absolute', width: '100%', height: 100, zIndex: 9999 }}>
                <Toastable statusMap={{ success: 'rgba(66, 126, 255, 0.85)', info: 'rgba(0, 0, 0, 0.85)' }} />
            </View>
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.pickerContainer}>
                        <Picker
                            ...
                            style={styles.picker}
                        >
                            {Degrees.map((item) => <Picker.Item key={item} label={item} value={item} />)}
                        </Picker>
                    </View>
                    ...
                    <View style={styles.pickerContainer}>
                        <Picker
                            ...
                            style={styles.picker}
                        >
                            {Semesters.map((item) => <Picker.Item key={item} label={item} value={item} />)}
                        </Picker>
                    </View>
                    ...
                    {(semester !== '' && semesterSubjects.length > 0) && (
                        ...
                        >
                            ...
                            {semesterSubjects.map((semesterItems, semesterIndex) => (
                                <View key={semesterIndex}>
                                    <Text style={styles.semesterLabel}>{Semesters[semesterIndex]} semester</Text>
                                    {semesterItems.map((subject, subjectIndex) => (
                                        <View key={subjectIndex} style={styles.subjectContainer}>
                                            <Text style={styles.subjectText}>{subject}</Text>
                                            <TextInput
                                                style={styles.marksTextField}
                                                value={subject.marks}
                                                onChangeText={(e) => handleMarksChange(semesterIndex, subjectIndex, e)}
                                                placeholder="Marks"
                                            />
                                        </View>
                                    ))}
                    ...
                    >
                        ...
                        <View style={styles.pickerContainer}>
                            <Picker
                                ...
                                onValueChange={(itemValue) => setTwelth({ ...twelth, stream: itemValue })}
                                style={styles.picker}
                            >
                    ...
                    >
                        ...
                        <TextInput
                            ...
                            placeholder="Backlog subjects"
                        />
                    </MotiView>
                    <TouchableOpacity style={styles.btn} onPress={handleClick}>
                        <Text style={styles.btnText}>Create Student</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
